  ...
  children: [
    {
      ...
      component: () => import('@/views/security/psec/config.vue'),
      meta: { title: t('app.psec.title') },
    },
    {
      path: 'ipsg',
      name: 'IPSGConfiguration',
      component: () => import('@/views/security/ipsg/config.vue'),
      meta: { title: t('app.ipsg.title') },
    },
    {
      path: 'dot1x',
      name: 'Dot1xConfiguration',
      component: () => import('@/views/security/dot1x/config.vue'),
      meta: { title: t('app.dot1x.title') },
    },
    {
      path: 'macauth',
      name: 'MacAuthConfiguration',
      component: () => import('@/views/security/macauth/config.vue'),
      meta: { title: t('app.macauth.title') },
    },
    {
      path: 'rad',
      name: 'RadConfiguration',
      component: () => import('@/views/security/rad/config.vue'),
